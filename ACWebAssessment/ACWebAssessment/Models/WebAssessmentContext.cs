...
namespace ACWebAssessment.Models
{
    public class WebAssessmentContext : DbContext
    {
        ...
        public System.Data.Entity.DbSet<ACWebAssessment.Models.Product> Products { get; set; }

        public class DataInitialiser : CreateDatabaseIfNotExists<WebAssessmentContext> //DropCreateDatabaseIfModelChanges<WebAssessmentContext>
        {
        ...
        public System.Data.Entity.DbSet<ACWebAssessment.Models.BasketItem> BasketItems { get; set; }

        public System.Data.Entity.DbSet<ACWebAssessment.Models.Order> Orders { get; set; }

        public System.Data.Entity.DbSet<ACWebAssessment.Models.Customer> Customers { get; set; }
    }
}
